...
function form_path_string(d) {
    ...
    //  M 50 50 A 50 50 0 0 1 100 50
    //  центр (50, 50), радиусы дуги по осям x (50) и y (50), 0 -- угол поворота дуги,
    //  0 -- флаг "большая дуга" (меньшая), 1 -- направление рисования (по часовой),
    //  конечная точка (100, 50)
